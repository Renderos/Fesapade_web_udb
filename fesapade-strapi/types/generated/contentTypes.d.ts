...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Cursos y fun jumps ofrecidos por FESAPADE';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    moneda: Schema.Attribute.String & Schema.Attribute.DefaultTo<'USD'>;
...
export interface ApiGalleryItemGalleryItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Galer\u00EDa fotogr\u00E1fica y de video de FESAPADE';
  ...
  attributes: {
    categoria: Schema.Attribute.Enumeration<['foto', 'video']> &
...
export interface ApiNewsItemNewsItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Noticias y eventos de FESAPADE';
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configuraci\u00F3n global del sitio: contacto y redes sociales';
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Miembros del equipo directivo de FESAPADE';
